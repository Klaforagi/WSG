...
EventConfig.EventDefs = {
    MeteorShower = {
        Name       = "Meteor Shower",
        Objective  = "",
        Reward     = "5 Coins Per Shard",
        Announcement = "Meteor Shower",
        AnnouncementColor = Color3.fromRGB(200, 230, 255),
        RequiredShards = 0,
    ...
    GoldRush = {
        ...
        AnnouncementColor = Color3.fromRGB(255, 210, 70),
        RequiredCoins = 0,
        PickupRewardCoins = 3,
        CompletionRewardCoins = 0,
        MaxRewardCoins = 60,
    ...
    GoblinRaid = {
        ...
        AnnouncementColor = Color3.fromRGB(110, 190, 70),
        DurationSeconds = 60,
