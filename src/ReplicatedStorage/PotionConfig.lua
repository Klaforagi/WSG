...
local orderedPotions = {
    ...
    },
    {
        ...
        Category = "Battle",
        Description = "Equip it to slot 4 to gain +6 movement speed for 8 seconds.",
        DetailText = "+6 Move Speed for 8s",
        PriceCoins = 30,
        PriceRobux = 7,
        StockPerRefresh = 4,
    ...
    },
    {
        ...
        Category = "Battle",
        Description = "Increase melee damage by +5 per attack and increase your size by +2 for 10 seconds.",
        DetailText = "+5 Melee Damage, +2 Size for 10s",
        PriceCoins = 45,
        PriceRobux = 9,
        StockPerRefresh = 3,
