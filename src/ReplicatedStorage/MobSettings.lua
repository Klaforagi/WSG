...
local Defaults = {
    ...
    Movement = {
        ...
        StuckJumpDelay   = 1, -- seconds without meaningful walking progress
        StuckJumpCooldown = 2.5,
        StuckJumpMaxTargetHeight = 30, -- do not hop after players far above the mob
    },
    Attack = {
        Damage      = 5,
