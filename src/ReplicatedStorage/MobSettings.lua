...
local presets = {
    Zombie = {
        ...
        show_hitbox      = true,                     -- debug: show hitbox part when attacking
    ...
    Zack = {
        ...
        show_hitbox      = true,
        hitbox_color     = Color3.fromRGB(255, 100, 50),
        attack_anim_id   = "",
        detection_radius = 40,
        aggro_duration   = 12,
        tag              = "ZombieNPC",
    ...
    Orc = {
        ...
        show_hitbox      = true,
        hitbox_color     = Color3.fromRGB(50, 255, 50),
        attack_anim_id   = "rbxassetid://122917464230305",
        detection_radius = 20,
        aggro_duration   = 8,
        tag              = "ZombieNPC",
    ...
    Ogre = {
        ...
        attack_windup    = 0.5,
        attack_sound     = "OrcAttack",
        hitbox_size      = Vector3.new(6, 8, 6),
        hitbox_offset    = Vector3.new(0, 0, 3.5),
        show_hitbox      = true,
        hitbox_color     = Color3.fromRGB(180, 50, 255),
        attack_anim_id   = "rbxassetid://72805951274249",
        detection_radius = 25,
        aggro_duration   = 10,
        tag              = "ZombieNPC",
        walk_anim_id     = "",
