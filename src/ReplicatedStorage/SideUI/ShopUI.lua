--------------------------------------------------------------------------------
-- ShopUI.lua  –  Reference-style shop grid (icon left · price right · BUY)
--------------------------------------------------------------------------------
...
function ShopUI.Create(parent, coinApi, inventoryApi)
    ...
    ---------------------------------------------------------------------------
    local function makeItem(id, displayName, price, iconKey)
        ...
        -- RIGHT half: price row, name, buy button (stacked vertically)
        ...
        -- price row (number + coin icon) — top area
        local priceRow = Instance.new("Frame")
        priceRow.Name = "PriceRow"
        priceRow.Size = UDim2.new(1, 0, 0.30, 0)
