...
function DailyQuestsUI.Create(parent, _coinApi, _inventoryApi, initialTabOrOptions)
    ...
    ---------------------------------------------------------------------------
    -- Tab definitions (daily/weekly removed; only Achievements tab retained)
    ---------------------------------------------------------------------------
    local TAB_DEFS = {
    ...
    ---------------------------------------------------------------------------
    -- Daily/Weekly pages removed by request.
    -- updateTabIndicators now only handles Achievements indicators.
    ---------------------------------------------------------------------------
    ...
    -- Initial indicator refresh (achievements only)
    updateTabIndicators()
    ---------------------------------------------------------------------------
    ...
    ---------------------------------------------------------------------------
    -- Live weekly/daily quest updates removed (Daily/Weekly pages deleted)
    ---------------------------------------------------------------------------
