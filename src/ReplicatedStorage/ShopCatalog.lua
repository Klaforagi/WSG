...
ShopCatalog.Items = {
    {
        ...
        BadgeText = "BUNDLE",
        SaleBadgeText = "96% OFF",
        OriginalPriceRobux = 499,
        Description = "1,000 Coins, 500 Salvage, and 1 Key.",
        PriceRobux = 19,
        ProductId = 0,
        OneTimePurchase = true,
        OwnedAttribute = "StarterPackPurchased",
    ...
    },
    {
        ...
        BadgeText = "VIP",
        Description = "[VIP] chat prefix plus 0.2x Coins, XP, and Mastery from combat, flag captures, and events.",
        PriceRobux = 799,
        GamePassId = 0,
    ...
    },
    {
        ...
        BadgeText = "COINS",
        Description = "Doubles Coins from combat, flag captures, and timed events.",
        PriceRobux = 399,
        GamePassId = 0,
    ...
    },
    {
        ...
        BadgeText = "XP",
        Description = "Doubles XP from combat, flag captures, and timed events.",
        PriceRobux = 299,
        GamePassId = 0,
    ...
    },
    {
        ...
        DisplayName = "Bandage",
        BadgeText = "BANDAGE",
        Description = "Unlock a permanent bandage to heal yourself and others",
        PriceRobux = 349,
        GamePassId = 0,
    ...
    },
    {
        ...
        BadgeText = "MASTERY",
        Description = "Doubles Mastery XP earned in combat.",
        PriceRobux = 399,
        GamePassId = 0,
